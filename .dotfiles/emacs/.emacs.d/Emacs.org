...
(defun my-org-mode-remove-pcomplete ()
  (setq completion-at-point-functions
        (remove 'pcomplete-completions-at-point completion-at-point-functions)))

(add-hook 'org-mode-hook #'my-org-mode-remove-pcomplete)
...
(use-package hydra
  ...
  (defhydra hydra-fireball-and-earthquake (:timeout 4)
    "calculate fireball damages"
    ("j" fireball-and-earthquake-calculator "fireball and earthquake")
    ("k" fireball-hp-building-left  "hp left after fireball")
    ("l" earthquake-hp-building-left "hp left after earthquakes")
    ("f" nil "finished" :exit t))
  (ox/leader-keys
    "h" '(:ignore t :which-key "hydra")
    "hs" '(hydra-text-scale/body :which-key "scale text")
    "hf" '(hydra-fireball-and-earthquake/body :which-key "fireball damages")))
