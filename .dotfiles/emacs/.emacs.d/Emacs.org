...
(defun my-disable-transclusion-mode ()
  "Disable org-transclusion-mode."
  (if (eq org-transclusion-mode t)
      (org-transclusion-mode -1)))

(defun my-enable-transclusion-mode ()
  "Enable org-transclusion-mode."
  (if (eq org-transclusion-mode nil)
      (org-transclusion-mode 1)))

(advice-add 'org-fc-review-rate-easy :before #'my-disable-transclusion-mode)
(advice-add 'org-fc-review-rate-easy :after #'my-enable-transclusion-mode)
(advice-add 'org-fc-review-rate-good :before #'my-disable-transclusion-mode)
(advice-add 'org-fc-review-rate-good :after #'my-enable-transclusion-mode)
(advice-add 'org-fc-review-rate-hard :before #'my-disable-transclusion-mode)
(advice-add 'org-fc-review-rate-hard :after #'my-enable-transclusion-mode)
