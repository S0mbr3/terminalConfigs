...
As of temporary situation waiting for the [[https://github.com/AndreaCrotti/yasnippet-snippets/pull/504][PR]] to yasnippet-snippets [[(setq yasnippet-snippets-dir][the snippets dir]] is settled manually to a local directory
...
(use-package yasnippet-snippets
  ...
  :after yasnippet
  :config
  (setq yasnippet-snippets-dir "/home/oxhart/.emacs.d/snippets/"))
