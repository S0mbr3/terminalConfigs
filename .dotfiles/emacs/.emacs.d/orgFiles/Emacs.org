...
#+STARTUP: overview
#+PROPERTY: header-args:emacs-lisp :tangle ../init.el :auto-tangle t :lexical t
...
(setq ox/enable-cape t "Enable Cape package.")
#+end_src
* Startup Performance
...
(setq my-org-files '("~/.emacs.d/orgFiles/Tasks.org"
...
(use-package org
  ...
  (setq org-link-frame-setup
	...
	(ox/leader-keys
	  ...
	  "oh" '((lambda () (interactive) (find-file "~/.emacs.d/orgFiles/Habits.org")) :which-key "Open Habits.org")))
